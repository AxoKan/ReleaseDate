...
<li class="menu-item <?php if($uri->getSegment(2) == "game1"){echo "active";}?> <?php if($uri->getSegment(2) == "tambah"){echo "active";}?> <?php if($uri->getSegment(2) == "edit"){echo "active";}?> ">
    <a href="<?= base_url("Home/game1") ?>" class="menu-link">
      <i class="menu-icon tf-icons bx bx-game"></i>
      <div data-i18n="Analytics">Game</div>
    </a>
</li>
